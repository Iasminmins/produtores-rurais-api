...
export class ProducerService {
  ...
  async create(createProducerDto: CreateProducerDto): Promise<Producer> {
    const producer = this.producerRepository.create(createProducerDto as any);
   await this.producerRepository.save(producer);
   return producer as unknown as Promise<Producer>;
  }
  ...
  async update(id: number, updateProducerDto: UpdateProducerDto): Promise<Producer> {
    await this.producerRepository.update(id, updateProducerDto as any );
